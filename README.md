...
```bash
java -jar skills/igapyon-miku-indexgen/runtime/miku-indexgen-1.6.2.jar --input-directory docs --exclude-glob "**/images/*"
```
...
- `igapyon/miku-indexgen` release `v1.6.2`
- `igapyon/miku-indexgen-java` release `v1.6.2`
