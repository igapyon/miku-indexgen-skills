...
```bash
java -jar skills/igapyon-miku-indexgen/runtime/miku-indexgen-1.6.2.jar --input-parent-directory docs-parent --output-directory workplace/indexgen --markdown
```
...
```bash
java -jar skills/igapyon-miku-indexgen/runtime/miku-indexgen-1.6.2.jar --refresh-index skills/igapyon-miku-indexgen/index.json
```
...
Agent Skill package version: `1.6.2`.

Bundled runtime artifacts:

- `skills/igapyon-miku-indexgen/runtime/miku-indexgen-1.6.2.mjs`
- `skills/igapyon-miku-indexgen/runtime/miku-indexgen-1.6.2.jar`
